...
const CoursesSection = () => {
  ...
  return (
    <div className='py-25 w-4/5 m-auto flex flex-col gap-5 items-center'>
        ...
        <div className='grid xl:grid-rows-1 xl:grid-cols-4 sm:grid-cols-2 sm:grid-rows-2 grid-cols-1 grid-rows-4 gap-10 my-5'>{courses.slice(2,6).map((course) => <CourseCard course={course} key={course._id}/>)}</div>
