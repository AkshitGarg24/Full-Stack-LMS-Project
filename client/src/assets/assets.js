...
export const dummyCourses = [
    {
        ...
        "courseTitle": "Introduction to JavaScript",
        "courseDescription": "Learn the Basics of JavaScript. JavaScript is a versatile programming language that powers the web. In this course, you will learn the fundamentals of JavaScript, including syntax, data types, and control structures.This course is perfect for beginners who want to start their journey in web development. By the end of this course, you will be able to create interactive web pages and understand the core concepts of JavaScript.Understand the basics of programming and learn how to manipulate the DOM and create dynamic web applications",
        "coursePrice": 49.99,
        "isPublished": true,
        "discount": 20,
        "courseContent": [
    ...
    },
    {
        "_id": "675ac1512100b91a6d9b8b24",
        "courseTitle": "Advanced Python Programming",
        "courseDescription": "Deep Dive into Python ProgrammingThis course is designed for those who have a basic understanding of Python and want to take their skills to the next level. You will explore advanced topics such as decorators, generators, and context managers.By the end of this course, you will be able to write efficient and clean Python code, and understand how to leverage Python's powerful features for real-world applications. Master advanced data structures, implement object-oriented programming concepts and work with libraries and frameworks",
        "coursePrice": 79.99,
        "isPublished": true,
        "discount": 15,
        "courseContent": [
    ...
    },
    {
        ...
        "courseTitle": "Cybersecurity Basics",
        "courseDescription": "Protect Systems and Networks. Cybersecurity is critical in today's digital age. This course introduces the fundamentals of cybersecurity, including threat analysis, ethical hacking, and secure programming practices. By the end of this course, you will understand how to identify vulnerabilities and implement security measures effectively.Understand security protocolsLearn about encryption techniques and conduct basic penetration testing",
        "coursePrice": 69.99,
        "isPublished": true,
        "discount": 15,
        "courseContent": [
    ...
    },
    {
        ...
        "courseTitle": "Web Development Bootcamp",
        "courseDescription": "Become a Full-Stack Web Developer. This comprehensive bootcamp covers everything you need to know to become a full-stack web developer. From HTML and CSS to JavaScript and backend technologies, this course is designed to take you from beginner to job-ready.Throughout the course, you will work on real-world projects, build a portfolio, and gain the skills necessary to succeed in the tech industry.Learn front-end and back-end development, build responsive and dynamic web applications, understand databases and server-side programming",
        "coursePrice": 99.99,
        "isPublished": true,
        "discount": 25,
        "courseContent": [
    ...
    },
    {
        ...
        "courseDescription": "Master Cloud Fundamentals. Learn the foundations of cloud computing and explore popular cloud platforms like AWS, Azure, and Google Cloud. This course is ideal for IT professionals and developers looking to transition to cloud-based solutions.By the end of this course, you will understand cloud services, deployment models, and best practices for using cloud resources efficiently.Understand cloud architectureLearn to work with AWS, Azure, and GCPExplore serverless computing and storage solutions",
        "coursePrice": 69.99,
        "isPublished": true,
        "discount": 20,
        "courseContent": [
    ...
    },
    {
        ...
        "courseTitle": "Data Science with Python",
        "courseDescription": "Start Your Data Science JourneyData Science is one of the most in-demand fields in the world. This course teaches you the essentials of data analysis, visualization, and machine learning using Python. Learn libraries like Pandas, NumPy, Matplotlib, and Scikit-learn.By the end of this course, you will be equipped to work on real-world data projects and gain insights from data.",
        "coursePrice": 89.99,
        "isPublished": true,
        "discount": 20,
        "courseContent": [
    ...
    },
    {
        ...
        "courseDescription": "Unlock the Power of DataThis course provides a comprehensive introduction to data science and machine learning. You will learn how to analyze data, build predictive models, and apply machine learning algorithms to real-world problems.By the end of this course, you will have a solid understanding of data manipulation, visualization, and machine learning techniques, enabling you to make data-driven decisions.Understand data analysis and visualization, learn machine learning algorithms and their applications. work with popular data science libraries like Pandas and Scikit-Learn",
        "coursePrice": 89.99,
        "isPublished": true,
        "discount": 30,
        "courseContent": [
    ...
    },
    {
        ...
        "courseDescription": "Protect the Digital World. This course covers the essentials of cybersecurity, including understanding threats, vulnerabilities, and how to secure systems against cyber-attacks. Ideal for beginners, this course will prepare you for a career in cybersecurity.By the end of this course, you will be able to identify and mitigate risks, implement security best practices, and understand the fundamentals of encryption and network security.Understand common cybersecurity threatsLearn about encryption and secure communicationExplore tools for penetration testing",
        "coursePrice": 59.99,
        "isPublished": true,
        "discount": 15,
        "courseContent": [
